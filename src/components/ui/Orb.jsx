...
export default function Orb({
  ...
  // Modified fragment: baseColor1 = white, baseColor2 = teal rgb(0,180,166), baseColor3 = dark teal
  const frag = `
    precision highp float;
    ...
    /* Teal + White palette */
    const vec3 baseColor1 = vec3(0.95, 0.98, 1.00);        /* near white */
    const vec3 baseColor2 = vec3(0.0,  0.706, 0.651);      /* teal rgb(0,180,166) */
    const vec3 baseColor3 = vec3(0.0,  0.25,  0.27);       /* dark teal */
