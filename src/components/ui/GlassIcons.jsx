...
const gradientMapping = {
  ...
  cyan: 'linear-gradient(hsl(180, 100%, 40%), hsl(180, 100%, 30%))',
  pink: 'linear-gradient(hsl(330, 100%, 60%), hsl(330, 100%, 50%))',
  teal: 'linear-gradient(hsl(160, 100%, 40%), hsl(160, 100%, 30%))',
  yellow: 'linear-gradient(hsl(45, 100%, 50%), hsl(35, 100%, 50%))',
};
...
const GlassIcons = ({ items, className }) => {
  ...
  return (
    <div className={`flex flex-wrap justify-center gap-[5em] mx-auto py-[3em] overflow-visible ${className || ''}`}>
      {items.map((item, index) => (
        ...
        >
          <span
            ...
            style={{
              ...getBackgroundStyle(item.color || 'blue'),
          ...
          <span className="absolute top-full left-0 right-0 text-center whitespace-nowrap leading-[2] text-sm md:text-base font-bold text-white opacity-0 transition-[opacity,transform] duration-300 ease-[cubic-bezier(0.83,0,0.17,1)] translate-y-0 group-hover:opacity-100 group-hover:[transform:translateY(20%)]"
