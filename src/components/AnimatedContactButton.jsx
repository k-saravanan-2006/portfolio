...
const AnimatedContactButton = ({ btnState }) => {
  const isSent = btnState === 'sent';
  const isSending = btnState === 'sending';
  const displayText = isSending ? "Sending..." : (isSent ? "Message Sent!" : "Send Message");

  return (
    <div className="button-container relative mx-auto my-8">
